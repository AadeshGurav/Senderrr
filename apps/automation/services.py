...
# WhatsApp Web DOM selectors (fragile — verify against live DOM)
SELECTORS = {
...
def _apply_anti_ban_jitter() -> None:
    ...
    delay = random.uniform(
        settings.AUTOMATION_JITTER_MIN,
        settings.AUTOMATION_JITTER_MAX,
    )
...
def _ensure_whatsapp_loaded(page) -> None:  # noqa: ANN001
    ...
    if WHATSAPP_WEB_URL not in current_url:
        ...
        page.goto(WHATSAPP_WEB_URL, wait_until="networkidle", timeout=60_000)
